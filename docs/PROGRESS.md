...
| 2026-09-24 | T1.1 | feat/t1.1-generator-config | Strict config models + preset loading, fraction → date calendar, name-keyed SeedSequence streams (golden-value test), atomic run manifest, `hirestream generate backfill` + `make generate`; 65 tests, 98% coverage |
