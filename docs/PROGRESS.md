...
**Current phase:** 1 · **Next task:** T1.7 · **Last updated:** 2026-09-25 (T1.6b)
...
| 2026-09-25 | T1.6b | feat/t1.6b-ats-postgres | ATS source DDL + PostgresSink (ADR-0009): strict schema, atomic COPY load, payload hashes in the manifest, fail-fast connection check, `--skip-ats-db`; integration tests on a CI Postgres service |
