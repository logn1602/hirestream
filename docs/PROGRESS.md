...
| 2026-09-23 | T0.6 | ci/t0.6-protect-main | Ruleset `protect-main` active on main (PR required, 0 approvals, merge-only; lint, test, secrets, stack required; no force push, deletion, or bypass), versioned in `.github/rulesets/main.json` |
