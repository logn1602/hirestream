...
| 2026-09-24 | T1.3 | feat/t1.3-workforce-hris | Workforce engine + daily HRIS snapshots with chaos (ADR-0005): invariants hold every day, rates track config; late exports carry true dates; byte-identical files per seed; full = 545 files, 12.8M rows, 378 MB in 84 s at 114 MB RSS |
