...
| 2026-09-24 | T1.2 | feat/t1.2-world-builder | World builder (ADR-0004): steady-state tenure/time-in-role/leave, 5–9 span management tree, exact level/role/location quotas, hire-ordered ids, seeded Faker names + `.example` emails; tiny/dev/full build in 0.1/0.3/1.9 s; golden world fingerprint |
